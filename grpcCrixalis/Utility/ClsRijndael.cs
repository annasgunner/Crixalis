    ...
    public class ClsRijndael
{
        ...
        private readonly string passPhrase = "$3|2@|>|-|1M";                   // can be any string
        private readonly string saltValue = "failingtoplanisplanningtofail";   // can be any string
        private readonly int passwordIterations = 33;                      // can be any number
        private readonly string initVector = "^^Z7y6X5w4V3u2T1";               // must be 16 bytes
        ...
        public string Encrypt(string plainText)
        {
            ...
            // Untuk solve error = "Padding is invalid and cannot be remobed
